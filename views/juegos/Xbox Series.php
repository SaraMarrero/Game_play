<?php 
	// Valida si existe un $_GET en Xbox Series.php
	if(!$_GET){
		header('Location: /juegos/Xbox Series?pagina=1');
	}
...
<section class="bg-gradient-to-r from-gray-900 via-green-600 to-gray-900">
	<main class="w-3/5 m-auto bg-green-950">
		<h1 class="text-center p-5 font-bold text-3xl text-gray-200">Xbox Series X</h1>
		...
		<div class="flex-1 flex justify-center mr-auto py-5">
			<nav class="content-center">
				<ul class="inline-flex -space-x-px">
					...
					<li>
						<a href="/juegos/Xbox Series?pagina=<?php echo $_GET['pagina'] <= 1 ? $_GET['pagina'] : $_GET['pagina']-1; ?>"
					...
					<?php for($i = 1; $i <= $paginas; $i++){ ?>
						<li <?php echo $_GET['pagina'] == $i ? 'class="font-bold text-purple-900"' : 'class="text-gray-500"' ?>>
							<a href="/juegos/Xbox Series?pagina=<?php echo $i ?>""
					...
					<li>
						<a href="/juegos/Xbox Series.php?pagina=<?php echo $_GET['pagina'] >= $paginas ? $_GET['pagina'] : $_GET['pagina']+1; ?>"
