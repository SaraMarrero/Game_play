<?php 
	...
	if(!$_GET){
		header('Location: /juegos/Nintendo Switch?pagina=1');
	}
...
<section class="bg-gradient-to-l from-gray-900 via-red-500 to-gray-900">
	<main class="w-3/5 m-auto bg-red-950">
		<h1 class="text-center p-5 font-bold text-3xl text-gray-200">Nintendo Switch</h1>
		...
		<nav class="content-center">
			<ul class="inline-flex -space-x-px">
				...
				<li>
					<a href="/juegos/Nintendo Switch?pagina=<?php echo $_GET['pagina'] <= 1 ? $_GET['pagina'] : $_GET['pagina']-1; ?>"
				...
				<?php for($i = 1; $i <= $paginas; $i++){ ?>
					<li <?php echo $_GET['pagina'] == $i ? 'class="font-bold text-purple-900"' : 'class="text-gray-500"' ?>>
						<a href="/juegos/Nintendo Switch?pagina=<?php echo $i ?>""
				...
				<li>
					<a href="/juegos/Nintendo Switch?pagina=<?php echo $_GET['pagina'] >= $paginas ? $_GET['pagina'] : $_GET['pagina']+1; ?>"
